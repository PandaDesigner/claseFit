...
This delta introduces the `project-readme` capability: a single `README.md` at the repo root that captures the day-one contributor surface for the ClaseFit mobile MVP. It does NOT introduce behavior — the README is documentation only.
